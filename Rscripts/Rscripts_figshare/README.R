...
# IMPORTANT: File pathways will need to be edited in order to access the associated 
...
# from raw weekly dendrometer band reads of a sub-sample of trees from all canopy 
# strata from Nov. 2018 to Nov. 2019
