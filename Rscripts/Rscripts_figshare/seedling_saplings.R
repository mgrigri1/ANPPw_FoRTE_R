...
#importing csv
seedlings_raw <- read.csv("data/seedling_sapling.csv")

# convert factor vectors to numeric so we can do numeric calcualtions 
seedlings_raw$height_2018 <- as.numeric(as.character(seedlings_raw$height_2018))
...
# Use filter to create two eperate df's for each increment: June and August 
...
# calcualte stem density per hectare 
